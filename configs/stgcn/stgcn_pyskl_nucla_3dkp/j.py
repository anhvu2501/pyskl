model = dict(
    ...
    backbone=dict(
        type='STGCN',
        graph_cfg=dict(layout='nucla', mode='stgcn_spatial')),
    cls_head=dict(type='NewLossHead', num_classes=10, in_channels=256))

dataset_type = 'PoseDataset'
ann_file = 'data/nturgbd/nucla.pkl'
train_pipeline = [
    dict(type='PreNormalize3D'),
    dict(type='GenSkeFeat', dataset='nucla', feats=['j']),
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn/stgcn_pyskl_nucla_3d/j'
