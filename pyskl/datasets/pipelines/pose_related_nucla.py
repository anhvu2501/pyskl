...
class JointToBone:
    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        ...
        self.target = target
        if self.dataset not in ['nturgb+d', 'openpose', 'coco', 'handmp', 'nucla']:
            raise ValueError(
        ...
        if self.dataset == 'nturgb+d':
            ...
            self.pairs = ((0, 1), (2, 1), (3, 2), (4, 2), 
                (5, 4), (6, 5), (7, 6), (8, 2), (9, 8), 
                (10, 9), (11, 10), (12, 0), (13, 12), (14, 13), 
                (15, 14), (16, 0), (17, 16), (18, 17), (19, 18), (1, 1))
...
class JointToBoneD2:
    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        ...
        if self.dataset == 'nturgb+d':
            ...
            self.pairs = ((4, 1), (5, 2), (6, 4), (7, 5), (3 , 1), (8, 1), (9, 2), 
                        (10, 8), (11, 9), (12, 1), (13, 0), (14, 12), (15, 13), (16, 1),
                        (17, 0), (18, 16), (19, 17), (1, 1), (0, 0), (2, 2))
...
class GenSkeFeat:
    ...
    def __call__(self, results):
        if 'keypoint_score' in results and 'keypoint' in results:
            assert self.dataset not in ['nturgb+d', 'nucla'] 
